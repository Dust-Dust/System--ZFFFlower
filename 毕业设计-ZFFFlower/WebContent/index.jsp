...
<body>
	...
	<div id="main_box" class="main_box"
		style="width: 100%; height: 840px; z-index: 1;">
		<!-- div：登录框 -->
		<div id="login_box" style="width: 30%; height: 70%;">
			...
			<div id="login" style="width: 100%; height: 100%; margin: 0 auto;">
				<!-- h：标题 -->
				<h1
					style="text-align: center; color: white; font-family: 等线; font-size: 32px; padding-top: 80px;">教务管理系统登录</h1>
				<!-- table：学号+密码+登录按钮+注册跳转 -->
				<form  action="logindealServlet"
					method="post">
					<div style="width: 100%; height: 100%;margin: 0 auto">
						<tr>
							<td><input type="text" name="username" id="username_l"
								style="width: 300px; height: 30px; margin-top: 30px;"
								placeholder="学号" maxlength="16" /></td>
						</tr>
						<tr style="width: 20px; height: 40px;"></tr>
						<tr>
							<td><input type="password" name="userpass" id="userpass_l"
								style="width: 300px; height: 30px;" placeholder="密码"
								maxlength="16" /></td>
						</tr>
						<tr style="width: 20px; height: 40px;"></tr>
						<tr>
							<td><input style="font-weight: 600;" type="radio" value="C"
								...
								<input style="font-weight: 600; margin-left: 70px;" type="radio"
								value="B" name="usertype" /><span style="color: white;">&nbsp;教师&nbsp;</span>
								<input style="font-weight: 600; margin-left: 70px;" type="radio"
								value="A" name="usertype" /><span style="color: white;">&nbsp;管理员&nbsp;</span>
							</td>
						</tr>
						<tr style="width: 20px; height: 60px;"></tr>
						<tr>
							<td style="text-align: center;"><input type="submit"
								id="LoginButton" value="登录" style="width: 305px; height: 38px;"
								onclick="checkForm_l()" /></td>
						</tr>
						<tr style="width: 20px; height: 40px;"></tr>
						<td style="text-align: right; color: white;">没有账号？ <a
							id="register_b" style="color: cornflowerblue; cursor: pointer;">前去注册</a>
						</td>
						</tr>
					</div>
				</form>
		...
		<div id="register_box" style="width: 30%; height: 70%;">
			...
			<div id="register" style="width: 100%; height: 100%; margin: 0 auto;">
				<!-- h：标题 -->
				<h1
					style="color: white; font-family: 等线; font-size: 32px; margin-top: 70px; text-align: center;">账号注册</h1>
				<!-- table：学号+密码+确认密码+注册按钮+返回按钮 -->
				<table style="margin: auto;">
					<tr>
						<td><input type="text" name="username_r" id="username_r"
							style="width: 300px; height: 30px; margin-top: 30px; padding: 0;"
							placeholder="学号" maxlength="16" /></td>
					</tr>
					...
					<tr style="width: 20px; height: 30px;"></tr>
					<tr>
						<td><input type="password" name="userpass_ra"
							id="userpass_ra" style="width: 300px; height: 30px;"
							placeholder="确认密码" maxlength="16" /></td>
					</tr>
					<tr style="width: 20px; height: 50px;"></tr>
					<tr>
						<td style="text-align: center;"><input type="submit"
							name="submit" id="RegisterButton_r" value="注册"
							style="width: 305px; height: 38px;" onclick="checkForm_r()" /></td>
					</tr>
					<tr style="width: 20px; height: 30px;"></tr>
					<tr>
						<td style="text-align: center;"><input type="submit"
							name="submit" id="BackButton_r" value="返回"
							style="width: 305px; height: 38px;" /></td>
					</tr>
				</table>
			</div>
		</div>
